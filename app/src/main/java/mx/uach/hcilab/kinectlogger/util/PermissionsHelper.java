...
public class PermissionsHelper {
    ...
    //=========Constructors - START=========
    private PermissionsHelper(Activity activity, Fragment fragment, String[] permissions, int requestCode) {
    ...
    public PermissionsHelper(Activity activity, String[] permissions, int requestCode) {
        this.activity = activity;
        this.permissions = permissions;
        REQUEST_CODE = requestCode;
        checkIfPermissionPresentInAndroidManifest();
    ...
    public PermissionsHelper(Fragment fragment, String[] permissions, int requestCode) {
        this.fragment = fragment;
        this.permissions = permissions;
        REQUEST_CODE = requestCode;
        checkIfPermissionPresentInAndroidManifest();
